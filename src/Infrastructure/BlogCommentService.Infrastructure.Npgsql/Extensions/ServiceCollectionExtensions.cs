...
using BlogCommentService.Infrastructure.Npgsql.Repositories;
using Dapper;
...
namespace BlogCommentService.Infrastructure.Npgsql.Extensions;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddNpgsql(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ICommentRepository, NpgsqlCommentRepository>();
